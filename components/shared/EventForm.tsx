        ...
        <div className="flex flex-col gap-5 md:flex-row">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormControl>
                  <div className="flex-center h-[54] w-full overflow-hidden rounded-full bg-gray-50 px-4 py-2">
                    <Image
                      ...
                      height={24}
                    />
                    <Input placeholder="Event location or(and) Online" {...field} className="input-field" />
                  </div>
